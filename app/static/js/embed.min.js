(function () {
  ...
  chatbotButton.innerText = 'Trợ lý ảo';
  ...
  chatbotButton.onclick = () => {
    if (chatbotContainer.style.display === 'none') {
      // Thêm thông báo trong khi chờ iframe load
      chatbotButton.innerText = 'Đang tải...'; // Hiển thị trạng thái tải

      // Đợi 5 giây trước khi hiển thị iframe
      setTimeout(() => {
        ...
        if (!iframeCreated && window.ChatbotConfig) {
          ...
          // Reload lại iframe mỗi lần mở
          iframe.src = iframe.src; // Điều này sẽ reload lại iframe
