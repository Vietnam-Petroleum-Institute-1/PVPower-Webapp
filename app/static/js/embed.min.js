(function() {
  if (window.ChatbotConfig && window.ChatbotConfig.baseUrl && window.ChatbotConfig.userId && window.ChatbotConfig.sessionId) {
      ...
      document.cookie = "session_id=" + encodeURIComponent(window.ChatbotConfig.sessionId) + "; max-age=3600; path=/; domain=157.66.46.53; SameSite=None; Secure";
      document.cookie = "user_id=" + encodeURIComponent(window.ChatbotConfig.userId) + "; max-age=3600; path=/; domain=157.66.46.53; SameSite=None; Secure";
